...
const faqData = {
  ทั่วไป: [
    { q: "Homerun เชี่ยวชาญทรัพย์เขตใดบ้าง ?", a: "โฮมรันมีบริการทั่วกรุงเทพฯ และปริมณฑล" },
    { q: "Homerun เชี่ยวชาญทรัพย์ประเภทใดบ้าง ?", a: "เรามีบริการทั้งบ้าน คอนโด และทาวน์โฮม" },
    { q: "Homerun ยื่นข้อเสนอแบบใดบ้าง ?", a: "ยื่นข้อเสนอผ่านระบบออนไลน์ หรือให้ทีมงานช่วยเสนอได้" },
    { q: "Homerun ช่วยเพิ่มสภาพคล่องให้ตลาดอสังหาฯ อย่างไร?", a: "ด้วยการเชื่อมผู้ซื้อและผู้ขายโดยตรงผ่านระบบดิจิทัล" },
  ],
  ผู้ขาย: [
    { q: "Homerun เชี่ยวชาญทรัพย์เขตใดบ้าง ?", a: "เรามีทีมขายดูแลทุกเขตในกรุงเทพฯ" },
    { q: "Homerun เชี่ยวชาญทรัพย์ประเภทใดบ้าง ?", a: "รับขายทุกประเภท บ้าน คอนโด และทาวน์โฮม" },
    { q: "ข้อตกลงในการประเมินทรัพย์เบื้องต้น ?", a: "ไม่มีค่าใช้จ่ายในการประเมินทรัพย์เบื้องต้น" },
    { q: "Homerun ยื่นข้อเสนอแบบใดบ้าง ?", a: "ผู้ขายสามารถกำหนดราคาที่ต้องการได้เอง" },
  ...
  เอเจนท์: [
    { q: "Homerun เชี่ยวชาญทรัพย์เขตใดบ้าง ?", a: "เรามีทรัพย์ในทุกโซนของกรุงเทพฯ" },
    {
