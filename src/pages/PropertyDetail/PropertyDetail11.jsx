...
const PropertyDetailPage = () => {
  // Mock Data (อัปเดตสำหรับ Moon Tower Condo)
  const property = {
    title: "The Moonstone Thonglor",
    location: "Thonglor",
    // คำนวณจาก 202.17 * 108,819 = 21,999,937
    price: "฿22,000,000", 
    originalPrice: "", // ไม่ระบุ
    discount: "", // ไม่ระบุ
    tags: ["Renovated", "Luxury", "Large Unit"],
    images: [
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_0_13_Mar_2025_1741849568444.jpeg", // รูป Placeholder (ควรเปลี่ยนเป็นรูปจริงของ Moon Tower)
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_4_28_Feb_2025_1740711951939.jpeg",
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_5_28_Feb_2025_1740711951941.jpeg ",
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_18_28_Feb_2025_1740711951963.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_21_28_Feb_2025_1740711951970.jpeg",
    ],
    description: `The Moonstone Thonglor (Moontower) คอนโดรีโนเวทสไตล์ Modern Luxury & Classic บนทำเลที่ดีที่สุดในย่านทองหล่อ รายล้อมด้วยคาเฟ่ ร้านอาหาร และโรงเรียนนานาชาติ
    
    รีโนเวทใหม่สไตล์ Modern Luxury พร้อมเข้าอยู่ได้ทันที! ตกแต่งโดดเด่นด้วยฝ้า "พื้นผิวพระจันทร์" ที่มีเอกลักษณ์เฉพาะตัว เฟอร์นิเจอร์บิ้วท์อินจัดเต็ม พื้น SPC ทนทาน กันรอยขีดข่วน พร้อมฟังก์ชันครบครันสำหรับครอบครัวใหญ่`,
    
    features: [ // Highlight
      "ห้องขนาดใหญ่ 202.17 ตร.ม. 3 ห้องนอน 3 ห้องน้ำ",
      "1 ที่จอดรถล็อกตำแหน่ง (Fix Parking)",
      "ครัว Built-in ใหม่ ขนาดใหญ่ ใช้งานสะดวก",
      "ตกแต่งฝ้าเพดานด้วยดีไซน์พื้นผิวพระจันทร์",
      "พื้น SPC เกรดพรีเมียม ทนทาน",
      "ทำเลใจกลางทองหล่อ ใกล้ BTS และ Lifestyle Mall"
    ],
    specs: {
      landSize: "-", 
      area: "202.17 ตารางเมตร",
      floors: "9",
      pricePerSqm: "108,819 ฿",
    },
    rooms: {
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               {property.facilities.park > 0 && <RoomItem icon={<Trees />} count={property.facilities.park} label="สวนพักผ่อน" />}
               {property.facilities.sauna > 0 && <RoomItem icon={<Flame />} count={property.facilities.sauna} label="Sauna" />}
            </div>
          </div>
        </div>
      </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">Moon Tower Condo</div>
                <div className="text-xs text-gray-500 mt-1">Sukhumvit 59, Thong Lo</div>
            </div>
         </div>
       </div>
