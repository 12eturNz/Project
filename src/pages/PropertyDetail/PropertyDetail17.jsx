...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, Trees, Flame, Car, Briefcase // เพิ่ม Briefcase สำหรับ Co-working
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (The Diamond 11 - The Prime 11)
  const property = {
    ...
    discount: "-9%", 
    tags: ["Renovated", "Luxury", "Near BTS"],
    images: [
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_1_17_Dec_2024_1734405658581.jpeg", // Placeholder
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_3_17_Dec_2024_1734405658586.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_2_17_Dec_2024_1734405658583.jpeg ",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_5_17_Dec_2024_1734405658588.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_7_17_Dec_2024_1734405658590.jpeg",
    ],
    description: `The Diamond 11 @ The Prime 11 คอนโด Luxury รีโนเวทใหม่ใจกลางนานา เพียง 300 เมตรจาก BTS นานา
    
    Design Concept: Modern Contemporary ตกแต่งด้วยเส้นโค้งเพิ่มมิติและวัสดุไม้ให้ความอบอุ่น รีโนเวทใหม่ทั้งห้อง (เปลี่ยนระบบน้ำ-ไฟ-พื้น-สุขภัณฑ์)
    Highlight: เป็นห้องมุม ชั้นสูง ได้วิวเมืองและแสงธรรมชาติเต็มที่ พร้อมฟังก์ชันที่ตอบโจทย์ชีวิตคนเมือง`,
    
    features: [ // Highlight
      "ห้องมุม (Corner Unit) ชั้น 11 วิวเมือง",
      "ขนาด 89.73 ตร.ม. 2 ห้องนอน 2 ห้องน้ำ",
      "1 ที่จอดรถล็อกตำแหน่ง (Fixed Parking)",
      "รีโนเวทใหม่ทั้งหลัง พร้อมเฟอร์ฯ บางส่วน",
      "ครัว Built-in พร้อมเตาและเครื่องดูดควัน",
      "ใกล้ BTS นานา (300 ม.) และทางด่วน",
      "ส่วนกลางครบ: สระว่ายน้ำ, ฟิตเนส, Co-working Space"
    ],
    specs: {
      landSize: "-", 
      area: "89.73 ตารางเมตร",
      floors: "11",
      pricePerSqm: "110,331 ฿",
    },
    rooms: {
      ...
      kitchen: 1,
      living: 1,
      parking: 1, // Fixed Parking
    },
    facilities: {
      pool: 1, 
      fitness: 1,
      park: 1, 
      coworking: 1, // เพิ่ม Co-working space
      sauna: 0
    },
    code: "AO0036"
  };
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               {property.rooms.parking > 0 && (
                 <RoomItem icon={<Car />} count={property.rooms.parking} label="ที่จอดรถ (Fixed)" />
               )}
               ...
               {/* Co-working Space */}
               {property.facilities.coworking > 0 && (
                 <RoomItem icon={<Briefcase />} count={1} label="Co-working" />
               )}
            </div>
          </div>
        </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">The Diamond 11 (Sukhumvit 11)</div>
                <div className="text-xs text-gray-500 mt-1">Nana, Watthana</div>
            </div>
         </div>
       </div>
