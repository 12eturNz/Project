...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, Car
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (อัปเดตข้อมูล Siamese Surawong)
  const property = {
    title: "Siamese Surawong ",
    location: "ใกล้จุฬาฯ และ MRT สามย่าน",
    price: "฿13,900,000", // คำนวณคร่าวๆ จาก 127,993 x 108.6
    originalPrice: "฿14,900,000", 
    discount: "-7%",
    tags: ["Condo", "Near MRT Samyan", "Renovated"],
    images: [
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_0_23_Aug_2025_1755924629539.jpg", // รูปหลัก
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_1_23_Aug_2025_1755924629540.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_2_23_Aug_2025_1755924629541.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_3_23_Aug_2025_1755924629543.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_6_23_Aug_2025_1755924629546.jpg",
    ],
    description: `คอนโดรีโนเวทครัวใหญ่ ใกล้จุฬาฯ และ MRT สามย่าน
    คอนโดโลเคชันดี คนหาเยอะ เหมาะทั้งอยู่เองหรือปล่อยเช่า/ลงทุน เพราะใกล้มหาวิทยาลัยและสำนักงานย่านสีลม–สาทร
    
    จุดเด่น:
    - รีโนเวทใหม่ พร้อมอยู่ เดินถึง MRT สามย่าน
    - ใกล้จุฬาลงกรณ์ สามย่านมิตรทาวน์ และจามจุรีสแควร์
    - ส่วนกลางครบ: สระว่ายน้ำ ฟิตเนส และระบบรักษาความปลอดภัย
    - รีโนเวทและแก้ไขซ่อมแซม พร้อมเข้าอยู่ได้ทันที`,
    features: [ // Highlight
      "พื้นที่ใช้สอย 108.6 ตร.ม. กว้างขวาง",
      "3 ห้องนอน 2 ห้องน้ำ",
      "จอดรถได้ 2 คัน (1 Fixed, 1 Floating)",
      "ครัวใหญ่ เหมาะสำหรับครอบครัว",
      "ทำเลศักยภาพ ใกล้แหล่งการศึกษาและออฟฟิศ",
      "High Floor (ชั้น 18) วิวดี"
    ],
    specs: {
      landSize: "-", // คอนโด
      area: "108.6 ตารางเมตร",
      floors: "18",
      pricePerSqm: "127,993 ฿",
    },
    rooms: {
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="mt-4 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
              * ที่จอดรถ 2 คัน (1 Fixed, 1 Floating)
            </div>
          </div>
        </div>
      </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">Siamese Surawong</div>
