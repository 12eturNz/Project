...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, Trees, Flame, Car, Lock // เพิ่ม Lock สำหรับ Digital Door Lock
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (The Crest Sukhumvit 34)
  const property = {
    title: "The Crest Sukhumvit 34",
    location: "Sukhumvit 34",
    // คำนวณจาก 98.05 * 168,281 = 16,499,952
    price: "฿16,500,000", 
    originalPrice: "฿18,500,000", // ไม่ระบุ
    discount: "-11%", // ไม่ระบุ
    tags: ["Super Luxury", "Duplex", "Near BTS"],
    images: [
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_0_29_Jan_2025_1738126603832.jpeg", // Placeholder
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_1_29_Jan_2025_1738126603832.jpeg",
      "	https://img.homerunproptech.com/marketplace/marketplace_gallery_4_29_Jan_2025_1738126603833.jpeg ",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_6_29_Jan_2025_1738126603834.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_22_29_Jan_2025_1738126603840.jpeg",
    ],
    description: `The Crest Sukhumvit 34 คอนโด Super Luxury ติดถนนสุขุมวิท เพียง 100 เมตรจาก BTS ทองหล่อ
    
    Unit พิเศษแบบ Duplex (2 ชั้น) ให้ความรู้สึกโปร่งโล่งเหมือนอยู่บ้าน พร้อมตกแต่งใหม่ Fully Furnished สไตล์ Modern Luxury บิ้วท์อินครบชุดพร้อมเครื่องใช้ไฟฟ้า เข้าอยู่ได้ทันที`,
    
    features: [ // Highlight
      "ห้อง Duplex 2 ชั้น เพดานสูง โปร่ง โล่ง กว้าง",
      "ที่จอดรถ 2 คัน (1 Fixed + 1 Rotating)",
      "ทำเล Prime ติดถนนสุขุมวิท ใกล้ Emporium & EmQuartier",
      "ใกล้โรงเรียนนานาชาติ (Bangkok Prep, Trinity)",
      "ระบบความปลอดภัยสูง พร้อม Digital Door Lock",
      "ส่วนกลางระดับ Luxury ครบครัน"
    ],
    specs: {
      landSize: "-", 
      area: "98.05 ตารางเมตร", // รวมพื้นที่จอดรถระบุตามโฉนด
      floors: "12", // ชั้นที่
      pricePerSqm: "168,281 ฿",
    },
    rooms: {
      ...
      kitchen: 1,
      living: 1,
      parking: 2 // เพิ่มฟิลด์ที่จอดรถ
    },
    facilities: {
      pool: 1,
      fitness: 1,
      park: 1, 
      digitalLock: 1 // เพิ่ม Digital Door Lock
    },
    code: "AO0049"
  };
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               {/* แสดงที่จอดรถในรายการหลักเพราะเป็นจุดขายสำคัญ */}
               ...
               {/* Digital Door Lock */}
               {property.facilities.digitalLock > 0 && (
                  <div className="flex items-center gap-2 text-gray-600">
                    <span className="text-gray-400 w-5 h-5 [&>svg]:w-4 [&>svg]:h-4"><Lock /></span>
                    <span className="text-gray-500 font-light">Digital Door Lock</span>
                  </div>
               )}
            </div>
          </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">The Crest Sukhumvit 34</div>
                <div className="text-xs text-gray-500 mt-1">Super Luxury Class</div>
            </div>
         </div>
       </div>
