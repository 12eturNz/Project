...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, User, Lightbulb, CloudFog // เพิ่ม Icon สำหรับแม่บ้าน/แชนเดอเรีย/Sauna
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (อัปเดตข้อมูล คอนโดทองหล่อ AO0058)
  const property = {
    title: "The Waterford Park",
    location: "ทองหล่อ (ใกล้ BTS ทองหล่อ)",
    price: "฿23,900,000", // คำนวณจาก 112,471 * 212.5 = 23,900,087
    originalPrice: "฿25,000,000", 
    discount: "-4%",
    tags: ["Condo", "Thong Lo", "Large Unit"],
    images: [
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_0_13_Aug_2025_1755050147823.jpg", // รูปหลัก
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_6_13_Aug_2025_1755050147825.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_3_13_Aug_2025_1755050147824.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_4_13_Aug_2025_1755050147824.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_15_13_Aug_2025_1755050227440.jpg",
    ],
    description: `คอนโดร่มรื่น กลางซอยทองหล่อ ใจกลางสุขุมวิท ขนาดใหญ่พิเศษ 212 ตร.ม.
    อยู่ต้นซอยสุขุมวิท 53 และ 55 (ทองหล่อ) ใกล้ BTS ทองหล่อ เดินทางสะดวก
    รายล้อมด้วย Lifestyle Mall: Market Place, J Avenue, The Commons
    
    จุดเด่น:
    - ห้องมุมรีโนเวทใหม่ทั้งห้อง พร้อมเข้าอยู่ทันที
    - พื้นที่ใช้สอยกว้างขวางเหมือนอยู่บ้าน
    - สิ่งอำนวยความสะดวกครบครัน สระว่ายน้ำ ฟิตเนส ซาวน่า
    - ใกล้ รพ.สมิติเวช และโรงเรียนนานาชาติชั้นนำ`,
    features: [ // Highlight
      "ขนาดใหญ่พิเศษ 212.5 ตร.ม. ชั้น 19",
      "3 ห้องนอน 3 ห้องน้ำ + 1 ห้องแม่บ้าน",
      "รีโนเวทใหม่ ตกแต่งพร้อมโคมไฟแชนเดอเรีย",
      "ทำเลดีมาก อยู่ต้นซอยทองหล่อ/สุขุมวิท 53",
      "ใกล้ J Avenue, The Commons, Market Place",
      "ระบบรักษาความปลอดภัย 24 ชม."
    ],
    specs: {
      landSize: "-", // คอนโด
      area: "212.5 ตารางเมตร",
      floors: "19",
      pricePerSqm: "112,471 ฿",
    },
    rooms: {
      ...
      maid: 1, // ห้องแม่บ้าน
      kitchen: 1,
      multipurpose: 1, // ห้องอเนกประสงค์
      chandelier: 1 // แชนเดอเรีย
    },
    facilities: {
      pool: 1,
      fitness: 1,
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          <div>
             <div className="flex gap-2 mb-2">
                <span className="bg-amber-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">
                  {property.tags[0]}
                </span>
             </div>
             ...
             <div className="flex gap-2 flex-wrap">
                <span className="bg-purple-50 text-purple-700 text-xs px-3 py-1 rounded-md font-medium">
                 ...
                 <span className="bg-blue-50 text-blue-700 text-xs px-3 py-1 rounded-md font-medium">
                  {property.tags[2]}
                </span>
             </div>
          </div>
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               <RoomItem icon={<Layers />} count={property.rooms.multipurpose} label="ห้องอเนกประสงค์" />
               <RoomItem icon={<Utensils />} count={property.rooms.kitchen} label="ห้องครัว" />
               <RoomItem icon={<Lightbulb />} count={property.rooms.chandelier} label="โคมไฟแชนเดอเรีย" />
               ...
               <RoomItem icon={<CloudFog />} count={property.facilities.sauna} label="Sauna" />
            </div>

             {/* Note เพิ่มเติม */}
            <div className="mt-4 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
              * ใจกลางสุขุมวิท 53 และ 55 (ทองหล่อ)
            </div>
          </div>
        </div>
      </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">The Waterford Park</div>
