...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, Trees, Flame // เพิ่ม Icon สำหรับสิ่งอำนวยความสะดวก
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (ข้อมูลใหม่)
  const property = {
    title: "คอนโด 2 ห้องนอน ใกล้ BTS ทองหล่อ",
    location: "BTS ทองหล่อ (300 ม.)",
    price: "฿12,500,000", // คำนวณคร่าวๆ จาก 160,174 * 78.04
    originalPrice: "14,900,000", // ไม่ระบุ
    discount: "-16%", // ไม่ระบุ
    tags: ["Condo", "Near BTS", "Yield 5%"],
    images: [
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_0_06_Oct_2024_1728222954696.jpeg", // รูปหลัก
    ...
    จุดเด่น:
    - 78.04 ตร.ม 2 ห้องนอน 2 ห้องน้ำพร้อมอ่างอาบน้ำ
    - ชั้นสูงห้องมุม วิวเมือง
    - ปล่อยเช่าได้ yield 5%
    - ราคาถูกกว่าตอนเปิดตัวโครงการ
    - ห้องตกแต่งใหม่ ตรวจสอบสภาพและแก้ไขโดยช่างผู้เชี่ยวชาญ
    
   `,
    features: [ // Highlight / สิ่งอำนวยความสะดวก
      "ใกล้ BTS ทองหล่อเพียง 300 เมตร",
      "Built-in จัดเต็ม ครัวครบพร้อมเตาและเครื่องดูดควัน",
      "ส่วนกลางครบ สระว่ายน้ำ ห้องซาวน่า",
      "ห้องออกกำลังกาย พร้อมลานกิจกรรม",
      "เข้าออกได้ทั้งเส้นสุขุมวิท และ พระราม 4",
      "ห้องมุม วิวเมือง ชั้นสูง"
    ],
    specs: {
      landSize: "-", // คอนโดไม่มีที่ดิน (ตร.วา)
      area: "78.04 ตารางเมตร",
      floors: "15", // ชั้นที่
      pricePerSqm: "160,174 ฿",
    },
    rooms: {
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               <RoomItem icon={<Trees />} count={property.facilities.park} label="สวนสาธารณะ" />
