...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, Car, Trees, CloudFog, Laptop
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (อัปเดตข้อมูล คอนโดสุขุมวิท 26 สไตล์รีสอร์ท)
  const property = {
    title: "The Seed Sukhumvit 26 (2Beds)",
    location: "Sukhumvit 26",
    price: "฿7,500,000", 
    originalPrice: "฿8,690,000", 
    discount: "-14%",
    tags: ["Condo", "Pool Access", "Resort Style"],
    images: [
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_0_05_Jul_2024_1720155351377.jpeg", // รูปหลัก
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_1_05_Jul_2024_1720155351388.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_2_05_Jul_2024_1720155351388.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_4_05_Jul_2024_1720155351389.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_10_05_Jul_2024_1720155351400.jpeg",
    ],
    description: `คอนโดรีโนเวทใหม่ ซอยสุขุมวิท 26 ใกล้รถไฟฟ้า เงียบสงบเป็นส่วนตัว 
    คอนโดสไตล์รีสอร์ททำเล Prime Area ของสุขุมวิท เข้าออกได้ทั้งเส้นสุขุมวิท และพระราม 4
    
    จุดเด่นห้องชุด:
    - Special Unit ชั้น 1 ระเบียงใหญ่ เชื่อมต่อส่วนกลาง สระว่ายน้ำ และสนามเด็กเล่น
    - 2 ห้องนอน 2 ห้องน้ำ พร้อมอ่างอาบน้ำ เครื่องทำน้ำอุ่นแบบซ่อนใต้อ่าง
    - เปลี่ยนวอลเปเปอร์ และตกแต่งใหม่ ฟรีเฟอร์นิเจอร์ลอยตัว
    - ครัว Built-in ครบชุดพร้อมเตาไฟฟ้าและเครื่องดูดควัน
    - พื้นที่สีเขียวเยอะ มีสวนรอบโครงการ บรรยากาศร่มรื่น`,
    features: [ // Highlight
      "ใกล้ BTS พร้อมพงษ์ 600 เมตร",
      "ใกล้ Emporium 800 เมตร",
      "Special Unit ระเบียงเชื่อมสระว่ายน้ำ",
      "จอดรถได้ 2 คัน (Fix 1 คัน)",
      "Furniture Built-in + ลอยตัว",
      "บรรยากาศเงียบสงบ สไตล์รีสอร์ท"
    ],
    specs: {
      landSize: "-", // คอนโด
      area: "78.47 ตารางเมตร",
      floors: "1", // ชั้น 1 เชื่อมส่วนกลาง
      pricePerSqm: "95,578 ฿",
    },
    rooms: {
      bedroom: 2,
      ...
      kitchen: 1,
      living: 1,
      parking: 2 // จอดรถได้ 2 คัน
    },
    facilities: {
      pool: 1,
      fitness: 1,
      stream: 1, // Steam
      coworking: 1 // Co-working space
    },
    code: "AO0033"
  };
          ...
          <div>
             ...
             <div className="flex gap-2 flex-wrap">
                <span className="bg-blue-50 text-blue-700 text-xs px-3 py-1 rounded-md font-medium">
                 ...
                 <span className="bg-amber-50 text-amber-700 text-xs px-3 py-1 rounded-md font-medium">
                  {property.tags[2]}
                </span>
             </div>
          </div>
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               <RoomItem icon={<CloudFog />} count={property.facilities.stream} label="Stream" />
               <RoomItem icon={<Laptop />} count={property.facilities.coworking} label="Co-working" />
            </div>

             {/* Note เพิ่มเติม */}
            <div className="mt-4 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
              * จอดรถได้ 2 คัน (Fix 1 ตำแหน่ง) ชั้นใต้ดิน
            </div>
          </div>
        </div>
      </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">The Seed Sukhumvit 26</div>
