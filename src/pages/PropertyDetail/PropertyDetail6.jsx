...
import { 
  ...
  Utensils, Armchair, Waves, Dumbbell, Car, GraduationCap, School
} from 'lucide-react';

const PropertyDetailPage = () => {
  // Mock Data (อัปเดตข้อมูล Ruamjai Heights)
  const property = {
    title: "Ruamjai Heights คอนโดรีโนเวทห้องใหญ่ ใจกลางอโศก",
    location: "สุขุมวิท 15 (ตรงข้าม NIST)",
    price: "฿14,700,000", // *ราคาประเมินสมมติ (เนื่องจากไม่ได้ระบุมา)
    originalPrice: "", 
    discount: "",
    tags: ["Condo", "Near NIST School", "Large Unit"],
    images: [
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_0_04_Oct_2025_1759541347423.jpg", // รูปหลัก
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_5_04_Oct_2025_1759541347426.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_2_04_Oct_2025_1759541347425.jpg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_4_22_Aug_2025_1755845941201.jpeg",
      "https://img.homerunproptech.com/marketplace/marketplace_gallery_3_04_Oct_2025_1759541347426.jpg",
    ],
    description: `Ruamjai Heights คอนโดรีโนเวทห้องใหญ่ ใจกลางอโศก อยู่ในซอยสุขุมวิท 15
    ทำเลทองสำหรับครอบครัว ตรงข้ามโรงเรียนนานาชาติ NIST และโรงเรียนวัฒนาวิทยาลัย
    
    จุดเด่น:
    - ห้องใหญ่ 147 ตร.ม. รีโนเวทใหม่พร้อมอยู่
    - ทำเลเงียบสงบในซอยสุขุมวิท 15 แต่เดินทางสะดวกทะลุได้หลายทาง
    - ใกล้ MRT เพชรบุรี และ BTS อโศก
    - เหมาะมากสำหรับครอบครัวที่มีลูกเรียนแถวอโศก-นานา`,
    features: [ // Highlight
      "พื้นที่ใช้สอยกว้าง 147 ตร.ม. ชั้น 16",
      "ตรงข้าม NIST และ Wattana Wittaya",
      "เดินไปโรงเรียนได้ใน 3 นาที",
      "ที่จอดรถ 2 คัน (1 Fix + 1 Float)",
      "2 ห้องนอน 2 ห้องน้ำ",
      "ซอยเงียบสงบ ร่มรื่น"
    ],
    specs: {
      ...
      area: "147 ตารางเมตร",
      floors: "16",
      pricePerSqm: "100,000฿", // คำนวณจากราคาสมมติ
    },
    rooms: {
      bedroom: 2,
      bathroom: 2,
      ...
      <div className="max-w-4xl mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          <div>
             <div className="flex gap-2 mb-2">
                <span className="bg-blue-800 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wide">
                  {property.tags[0]}
                </span>
             </div>
             ...
             <div className="flex gap-2 flex-wrap">
                <span className="bg-indigo-50 text-indigo-700 text-xs px-3 py-1 rounded-md font-medium">
                  {property.tags[1]}
                </span>
             </div>
          </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3 mb-8">
            ...
            <StatBox icon={<Tag size={20} />} label="ราคา/ตร.ม. (ประมาณ)" value={property.specs.pricePerSqm} />
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 gap-y-4 text-sm text-gray-700">
               ...
               <RoomItem icon={<GraduationCap />} count={property.facilities.school} label="ใกล้โรงเรียน" />
            </div>
       ...
       <div className="max-w-4xl mx-auto px-4 mb-8">
         ...
         <div className="border border-gray-200 rounded-xl p-4 flex gap-4 items-center shadow-sm">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="font-semibold text-gray-900 truncate">Ruamjai Heights</div>
